...
class Config_Window(tkinter.Toplevel):
    ...
    def __click_button_save(self):
        ...
        if len(self.config_frame_dict) > 1:
            ...
            new_config = ConfigurationValues.check_create_insertion(configuration_values)
        else:
            new_config = ConfigurationValues.check_create_insertion(self.config_frame_dict[0])
            '''ConfigurationValues
